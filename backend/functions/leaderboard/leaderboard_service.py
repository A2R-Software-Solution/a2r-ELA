...
class LeaderboardService:
    ...
    def _get_user_profiles(self, uids: List[str]) -> Dict[str, Dict]:
        """
        Batch-fetch display names and profile photos.
    ...
    def _build_leaderboard(
        ...
        1. Fetches gamification data for all UIDs
        2. Fetches display names and profile photos
        3. Sorts by XP descending
        4. Returns top 10 + current user's rank
        ...
        # Fetch display names + profile photos
        user_profiles = self._get_user_profiles(active_uids)
